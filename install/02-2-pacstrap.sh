...
pacstrap /mnt base base-devel ${kernel} ${kernel}-headers linux-firmware ${microcode} refind grub grub-btrfs snapper efibootmgr sudo networkmanager apparmor nano firewalld ntfs-3g reflector snap-pac noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra git rsync zsh zsh-completions
